            ...
            <form id="form-add-edit-store" class="has-provinces" method="post" action="{{ $formOptions['action'] }}"
                ...
                <div class="row pt-md-1 pb-1">
                    <div class="col-12 col-md-6 mb-1">
                        <label class="form-label" for="form-type">Loại NT <span class="text-dangerNT">(*)</span></label>
                        ...
                        @if (isset($formOptions['files']))
                            <div class="image-thumbs">
                                @foreach ($formOptions['files'] as $item)
                                    ...
                                    <img src="{{ asset('storage/'.$item->source) }}" alt="{{ $item->name }}"
                                         class="thumb img-thumbnail mr-1">
                                @endforeach
                            </div>
                        @endif
                    </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 mb-1">
                                    ...
                                    <input type="text" name="vat_buyer" id="form-vat_buyer" class="form-control"
                                           value="{{ $default_values['vat_buyer'] }}">
                                </div>
                                ...
                                <div class="col-12 col-md-6 mb-1">
                                    ...
                                    <input type="text" name="vat_company" id="form-vat_company" class="form-control"
                                           value="{{ $default_values['vat_company'] }}">
                                </div>
                                ...
                                <div class="col-12 col-md-12">
                                    ...
                                    <textarea name="vat_address" id="form-vat_address" class="form-control"
                                              rows="2">{{ $default_values['vat_address'] }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row pt-1 pb-md-0">
                    <h5>Quản lý tuyến</h5>
                    <div class="col-md-6 col-12 mb-1">
                        <label class="form-label" for="form-line">Tuyến <span
                                class="text-danger">(*)</span></label>
                        <select id="form-line" class="form-control select2 has-select2 required" name="line" required>
                            <option value="">-- Chọn tuyến --</option>
                            @if(isset($formOptions['localityLines']) && count($formOptions['localityLines']))
                                @foreach($formOptions['localityLines'] as $line)
                                    <option
                                        value="{{ $line->id }}"
                                        {{ isset($default_values['line']) && $line->id == $default_values['line'] ? "selected":'' }}>
                                        {{ $line->name }}</option>
                                @endforeach
                            @endif
                        </select>
                    ...
                    <div class="col-md-6 col-12 mb-1">
                        ...
                        <select id="form-line_period" class="form-control" name="number_visit" required>
                            @foreach(Store::LINE_PERIOD as $keyPeriod => $period)
                                <option value="{{ $keyPeriod }}">{{ $period }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>

                <div class="row pt-1 pb-md-1">
