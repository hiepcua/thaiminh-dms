@php
    ...
    use \App\Models\User;
    $userLocalities     = $formOptions['userLocalities'] ?? null;
    $userDistricts      = $formOptions['userDistricts'] ?? null;
    $userWards          = $formOptions['userWards'] ?? null;
@endphp
        ...
        <div class="card-body">
            <form id="form-add-edit-store" class="has-provinces" method="post" action="{{ $formOptions['action'] }}"
                ...
                <div class="row mb-1">
                    ...
                    <div id="box-parent-store" class="pb-1"
                ...
                @endphp
                <div id="wg_tt_hoadon" class="row pt-md-1 pb-md-1">
                    <div class="col-12 col-md-6 mb-1">
                ...
                <div class="row pt-1 pb-md-0">
                    ...
                    <div class="col-md-6 col-12 mb-1">
                        <label class="form-label" for="form-line">Tuyến <span
                                class="text-danger">(*)</span></label>
                        <select id="form-line" class="form-control select2 has-select2" name="line" required>
...
@push('scripts-custom')
    ...
    <script>
        ...
        const IS_EDIT = "{{ request()->route()->getName() == 'admin.tdv.store.edit' }}";
