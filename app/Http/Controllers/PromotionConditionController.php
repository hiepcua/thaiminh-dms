...
use App\Services\PromotionConditionService;
...
class PromotionConditionController extends Controller
{
    ...
    public function __construct(
        PromotionConditionRepositoryInterface $repository,
        PromotionConditionService $service
    ) {
