...
<div class="wrap-repeater-promotion mt-1 inner-repeater template-type @if($typeDefault != 'type' . PromotionCondition::TYPE_DISCOUNT_BY_QTY) d-none @endif"
     data-template-type="type{{ PromotionCondition::TYPE_DISCOUNT_BY_QTY }}">
    <div data-repeater-list="type{{PromotionCondition::TYPE_DISCOUNT_BY_QTY}}" style="position: relative" class="border-secondary rounded">
        @if(count($infoTypeCondition['type' . PromotionCondition::TYPE_DISCOUNT_BY_QTY] ?? []))
{{--Edit screen--}}
            @foreach($infoTypeCondition['type' . PromotionCondition::TYPE_DISCOUNT_BY_QTY] ?? [] as $condition)
            ...
            <div data-repeater-item class="p-1 border-bottom">
                <!-- innner repeater -->
                <div class="p-1 condition-type{{PromotionCondition::TYPE_DISCOUNT_BY_QTY}}">
                    <div class="row">
                        ...
                        <label class="col-xl-10 col-md-10 col-sm-8 d-flex mb-1">
                            ...
                            <div class="w-100 include-product include-products">
                                <select class="has-select2 form-select select-product include-product" for-type="type{{PromotionCondition::TYPE_DISCOUNT_BY_QTY}}"
                        ...
                        <label class="col-xl-10 col-md-10 col-sm-8 d-flex">
                            <select class="form-select me-1 select-type-exclude"
                                    ...
                                    for-type="type{{PromotionCondition::TYPE_DISCOUNT_BY_QTY}}"
                                    name="excludeType"
                            >
                            ...
                            <div class="w-100 d-none exclude-product exclude-products">
                                <select class="has-select2 form-select select-product" for-type="type{{PromotionCondition::TYPE_DISCOUNT_BY_QTY}}" multiple name="excludeProducts">
                                    <option value="all">Tất cả</option>
                                    @foreach($formOptions['products'] ?? [] as $key => $product)
                            ...
                            <div class="w-100 d-none exclude-product exclude-groups">
                                <select class="has-select2 form-select select-product" for-type="type{{PromotionCondition::TYPE_DISCOUNT_BY_QTY}}" multiple name="excludeGroups">
                                    <option value="all">Tất cả</option>
                                    @foreach($formOptions['productGroups'] ?? [] as $key => $productGroup)
                        ...
                        <div class="deep-inner-repeater">
                            <table class="table table-striped table-bordered mb-1 sub-condition" data-repeater-list="gifts">
                                <thead>
                                    <tr>
                                        <th class="text-center" style="width: 200px">Số lượng SP</th>
                                ...
                                @foreach($condition['conditions'] ?? [] as $conditionGift)
                                    ...
                                    <td>
                                        <input type="number" class="form-control" name="productQty" value="{{ $conditionGift['productQty'] ?? null }}" min="1"/>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="number" class="form-control max-discount @if(($conditionGift['type'] ?? null) != PromotionCondition::TYPE_DISCOUNT_PERCENT) d-none @endif"
                                           name="maxDiscount" value="{{ $conditionGift['maxDiscount'] ?? null }}" min="1"/>
                                    </td>
                                    <td>
                                        <center>
                    ...
                    <div class="row">
                        ...
                        <div class="deep-inner-repeater">
                            <table class="table table-striped table-bordered mb-1 sub-condition" data-repeater-list="gifts">
                                ...
                                <tr class="condition-row" data-repeater-item>
                                    <td>
                                        <input type="number" class="form-control" name="productQty" min="1" />
                                    </td>
                                    <td>
