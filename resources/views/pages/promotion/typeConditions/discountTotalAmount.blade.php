...
<div class="wrap-repeater-promotion mt-1 inner-repeater template-type @if($typeDefault != 'type' . PromotionCondition::TYPE_DISCOUNT_BY_TOTAL_COST) d-none @endif"
     data-template-type="type{{ PromotionCondition::TYPE_DISCOUNT_BY_TOTAL_COST }}">
    <div data-repeater-list="type{{PromotionCondition::TYPE_DISCOUNT_BY_TOTAL_COST}}" style="position: relative" class="border-secondary rounded">
        @if(count($infoTypeCondition['type' . PromotionCondition::TYPE_DISCOUNT_BY_TOTAL_COST] ?? []))
{{--Edit screen--}}
            @foreach($infoTypeCondition['type' . PromotionCondition::TYPE_DISCOUNT_BY_TOTAL_COST] as $condition)
            ...
            <!-- innner repeater -->
            <div class="p-1 condition-type{{PromotionCondition::TYPE_DISCOUNT_BY_TOTAL_COST}}">
                <div class="row">
                    ...
                    <label class="col-xl-10 col-md-10 col-sm-8 d-flex mb-1">
                        ...
                        <div class="w-100 include-product include-products">
                            <select class="has-select2 form-select select-product include-product" for-type="type{{PromotionCondition::TYPE_DISCOUNT_BY_TOTAL_COST}}"
                    ...
                    <label class="col-xl-10 col-md-10 col-sm-8 d-flex">
                        <select class="form-select me-1 select-type-exclude"
                                ...
                                for-type="type{{PromotionCondition::TYPE_DISCOUNT_BY_TOTAL_COST}}"
                                name="excludeType"
                        >
                        ...
                        <div class="w-100 d-none exclude-product exclude-products">
                            <select class="has-select2 form-select select-product" for-type="type{{PromotionCondition::TYPE_DISCOUNT_BY_TOTAL_COST}}" multiple name="excludeProducts">
                                <option value="all">Tất cả</option>
                                @foreach($formOptions['products'] ?? [] as $key => $product)
                        ...
                        <div class="w-100 d-none exclude-product exclude-groups">
                            <select class="has-select2 form-select select-product" for-type="type{{PromotionCondition::TYPE_DISCOUNT_BY_TOTAL_COST}}" multiple name="excludeGroups">
                                <option value="all">Tất cả</option>
                                @foreach($formOptions['productGroups'] ?? [] as $key => $productGroup)
                    ...
                    <div class="deep-inner-repeater">
                        <table class="table table-striped table-bordered mb-1 sub-condition" data-repeater-list="gifts">
                            <thead>
                            <tr>
                                <th class="text-center" style="width: 200px">Số tiền tối thiểu</th>
                            ...
                            @foreach($condition['conditions'] as $conditionGift)
                                <tr class="condition-row" data-repeater-item>
                                    <td>
                                        <input type="number" class="form-control" name="minCost" value="{{ $conditionGift['minCost'] ?? null }}" min="1"/>
                                    </td>
                                    <td>
                                        <input type="number" class="form-control min-type"
                                           name="minType" max="{{ count($formOptions['products'] ?? []) }}" value="{{ $conditionGift['minType'] ?? null }}" min="1"/>
                                    </td>
                                    <td>
            ...
            <div data-repeater-item class="p-1 border-bottom">
                ...
                <div class="p-1 condition-type{{PromotionCondition::TYPE_DISCOUNT_BY_TOTAL_COST}}">
                    <div class="row">
                        <label class="col-xl-2 col-md-2 col-sm-4">SP áp dụng<span class="text-danger">(*)</span></label>
                        <label class="col-xl-10 col-md-10 col-sm-8 d-flex mb-1">
                            <select class="form-select me-1 select-type-include" style="min-width: 200px; width: 200px" name="includeType">
                        ...
                        <label class="col-xl-10 col-md-10 col-sm-8 d-flex">
                            <select class="form-select me-1 select-type-exclude"
                                    style="min-width: 200px; width: 200px"
                                    for-type="type{{PromotionCondition::TYPE_DISCOUNT_BY_TOTAL_COST}}" name="excludeType"
                            >
                        ...
                        <div class="deep-inner-repeater">
                            <table class="table table-striped table-bordered mb-1 sub-condition" data-repeater-list="gifts">
                                ...
                                <tr data-repeater-item class="condition-row">
                                    <td>
                                        <input type="number" class="form-control" name="minCost" min="1"/>
                                    </td>
                                    <td>
