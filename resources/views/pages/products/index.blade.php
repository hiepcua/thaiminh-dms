...
@push('content-header')
    <div class="col-auto ms-auto d-flex">
        <div>
            @include('component.btn-add', ['title' => 'Thêm Nhóm/SP UT', 'href' => route('admin.product-group-priorities.create')])
        </div>
        @can('them_san_pham')
            <div class="ms-1">
                @include('component.btn-add', ['title' => 'Thêm SP', 'href' => route('admin.products.create')])
            </div>
        @endcan
    </div>
@endpush
