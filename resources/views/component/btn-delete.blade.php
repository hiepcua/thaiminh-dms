<button class="btn-delete-row-table btn btn-sm btn-icon delete-record waves-effect waves-float waves-light" type="button" data-action="{{ $route }}" data-title="{{ $titleDelete }}">
