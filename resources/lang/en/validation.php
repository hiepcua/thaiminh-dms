...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'phone_receive_reward'          => 'số điện thoại nhận quà',
        'customer_phone_receive_reward' => 'số điện thoại nhận quà',
        'second'                        => 'giây',
        'sex'                           => 'giới tính',
        'size'                          => 'kích thước',
        'subject'                       => 'tiêu đề',
        ...
        'point'                         => 'điểm',
        'status'                        => 'trạng thái',
        'buy_store_address'             => 'địa chỉ nhà thuốc',
        'province_id'                   => 'tỉnh/thành',
        'customer_province_id'          => 'tỉnh/thành',
        'district_id'                   => 'quận/huyện',
        'customer_district_id'          => 'quận/huyện',
        'ward_id'                       => 'phường/xã',
        'customer_ward_id'              => 'phường/xã',
        'note'                          => 'ghi chú',
        'roles'                         => 'quyền',
        'organization_ids'              => 'sơ đồ tổ chức',
