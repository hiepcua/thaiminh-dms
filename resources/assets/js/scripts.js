                ...
                ajax(window['province']['route_get_districts'], 'get', {'province_id': _id})
                    .done(function (districts) {
                        $.each(districts, function (i, district) {
                            district_ele.append(`<option value="${district.id}" data-name="${district['district_name']}">${district['district_name']}</option>`);
                        })
                    });
            }
        });
                ...
                ajax(window['province']['route_get_wards'], 'get', {'district_id': _id})
                    .done(function (wards) {
                        $.each(wards, function (i, ward) {
                            ward_ele.append(`<option value="${ward.id}" data-name="${ward['ward_name']}">${ward['ward_name']}</option>`);
                        })
                    });
            }
        });
...
tmp_theme.component_search_form_mobile = () => {
    let component_search_form = $('.component-search-form');
